...
public class HelloBle extends Activity {
				...
				public void handlePitch(
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							text.setText(String.format(getString(R.string.display_message), freq, refFreq));
						}
					});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.activity_hello_ble, menu);
	...
	private void enableBluetooth() {
		stopRecording();
		Intent newIntent = new Intent(HelloBle.this,
